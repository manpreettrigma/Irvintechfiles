                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <a href="<?php echo base_url(); ?>admin/instructor/add"><button class="btn btn-success btn-sm" type="submit"><i class="fa  fa-plus-square"></i> Add Instructor</button></a>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"  width="100%">
                            ...
                            <tbody >
                                ...
                                foreach ($instructorList as $instructor) {
                                    ?>
                                    <tr>
                                        <td><?php if(isset($instructor['instructor_name'])){ echo $instructor['instructor_name']; } ?></td>
                                        <td><?php if(isset($instructor['instructor_desg'])){ echo $instructor['instructor_desg']; } ?></td>
                                        <td><?php if(isset($instructor['description'])){  echo $instructor['description']; } ?></td>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="viewMetaData_<?php echo $instructor['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <?php
                                                            if (!empty($instructor['meta_info'])) {
                                                                foreach ($instructor['meta_info'] as $meta_key => $metaInfo) {
                                                                    if (!empty($metaInfo)) {
                                                   ...
                                                   <!-- <a title="View" class="btn btn-success btn-xs" data-toggle="modal" data-target="#viewMetaData_<?php echo $instructor['id']; ?>" data-whatever="@getbootstrap"><i class="fa fa-folder"></i></a>-->
                                            <?php if ($instructor['status'] == 1) { ?>
                                                <a title="Deactivate" class="btn btn-danger btn-xs " href="<?php echo base_url() . "admin/instructor/block_instructor/" . $instructor['id']; ?>"><i class="glyphicon glyphicon-remove"></i></a> 
                                            <?php } if ($instructor['status'] == 0) { ?>
                                                <a title="Activate" class="btn btn-success btn-xs " href="<?php echo base_url() . "admin/instructor/unblock_instructor/" . $instructor['id']; ?>"><i class="glyphicon glyphicon-ok"></i></a> 
                                            <?php } ?>
                                            <a title="Edit" class="btn btn-success btn-xs " href="<?php echo base_url() . "admin/instructor/edit_instructor/" . $instructor['id']; ?>"><i class="glyphicon glyphicon-pencil"></i></a> 
                                            <a title="Delete" onclick="return confirm('Are you sure to want to delete?');" class="btn btn-danger btn-xs" href="<?php echo base_url() . "admin/instructor/delete/" . $instructor['id']; ?>"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr><?php } ?>
                            </tbody>
                        </table>
