                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" data-parsley-validate="" id="edit_product_form" name="edit_product_form" enctype="multipart/form-data" method="POST" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" id="product-title" name="instructor[instructor_name]" value="" class="form-control has-feedback-left required">
							...
							<div class="form-group">
                                <label for="product-title" class="control-label col-md-2 col-sm-3 col-xs-12">Instructor Desgination<span class="required">*</span>
                                </label>
                                <div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
                                <input type="text" placeholder="Title" id="product-title" name="instructor[instructor_desg]" value="" class="form-control has-feedback-left required">
                                    <span aria-hidden="true" class="fa fa form-control-feedback left">T</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
								    <textarea placeholder="Product Description" id="page_description" name="instructor[description]"class="form-control required"></textarea>
