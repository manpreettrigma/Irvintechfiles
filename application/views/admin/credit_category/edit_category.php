		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<form class="form-horizontal form-label-left"  id="edit_product_form" name="edit_product_form" action= "<?php echo base_url();?>admin/creditcategory/updateCategory" method="POST">
