                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <a href="<?php echo base_url(); ?>admin/workshop/add"><button class="btn btn-success btn-sm" type="submit"><i class="fa  fa-plus-square"></i> Add Workshop</button></a>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"  width="100%">
                            ...
                            <tbody >
                                ...
                                foreach ($workshopList as $workshop) {
                                    ?>
                                    <tr>
                                        <td><?php if(isset($workshop['title'])){ echo $workshop['title']; } ?></td>
                                        <td><?php if(isset($workshop['description'])){  echo $workshop['description']; } ?></td>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="viewMetaData_<?php echo $workshop['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            <h4 class="modal-title" id="exampleModalLabel">View Workshop</h4>
                                                        </div>
                                                        <div class="modal-body">

                                                            <?php
                                                            if (!empty($workshop['meta_info'])) {
                                                                foreach ($workshop['meta_info'] as $meta_key => $metaInfo) {
                                                                    if (!empty($metaInfo)) {
                                                   ...
                                                   <!-- <a title="View" class="btn btn-success btn-xs" data-toggle="modal" data-target="#viewMetaData_<?php echo $workshop['id']; ?>" data-whatever="@getbootstrap"><i class="fa fa-folder"></i></a>-->
                                            <?php if ($workshop['status'] == 1) { ?>
                                                <a title="Deactivate" class="btn btn-danger btn-xs " href="<?php echo base_url() . "admin/workshop/block_workshop/" . $workshop['id']; ?>"><i class="glyphicon glyphicon-remove"></i></a> 
                                            <?php } if ($workshop['status'] == 0) { ?>
                                                <a title="Activate" class="btn btn-success btn-xs " href="<?php echo base_url() . "admin/workshop/unblock_workshop/" . $workshop['id']; ?>"><i class="glyphicon glyphicon-ok"></i></a> 
                                            <?php } ?>
                                            <a title="Edit" class="btn btn-success btn-xs " href="<?php echo base_url() . "admin/workshop/edit_workshop/" . $workshop['id']; ?>"><i class="glyphicon glyphicon-pencil"></i></a> 
                                            <a title="Delete" onclick="return confirm('Are you sure to want to delete?');" class="btn btn-danger btn-xs" href="<?php echo base_url() . "admin/workshop/delete/" . $workshop['id']; ?>"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr><?php } ?>
                            </tbody>
                        </table>
