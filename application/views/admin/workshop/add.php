                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" data-parsley-validate="" id="edit_product_form" name="edit_product_form" enctype="multipart/form-data" method="POST" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" id="product-title" name="workshop[title]" value="" class="form-control has-feedback-left required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
								    <textarea placeholder="Product Description" id="page_description" name="workshop[description]"class="form-control required"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" placeholder="Price" id="product-title" name="workshop[price]" value="" class="form-control has-feedback-left required">
								...
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
										<input type="text" placeholder="Price" id="course_days" name="workshop[workshop_day]" value="" class="form-control has-feedback-left required">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
										<input type="text" placeholder="Price" id="course_time" name="workshop[workshop_time]" value="" class="form-control has-feedback-left required">
									</div>
								</div> 
								...
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-6 col-xs-12">
										<textarea class="form-control" name="workshop[workshop_learning_objectives]" rows="3" placeholder=""></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-6 col-xs-12">
										<textarea class="form-control" name="workshop[workshop_rtme]" rows="3" placeholder=""></textarea>
									</div>
								</div>
