                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" data-parsley-validate="" id="edit_product_form" name="edit_product_form" enctype="multipart/form-data" method="POST" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" id="product-title" name="certificate[title]" value="" class="form-control has-feedback-left required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
								    <textarea placeholder="Product Description" id="page_description" name="certificate[description]"class="form-control required"></textarea>
							...
							<div class="form-group">
									...
									<div class="col-md-10 col-sm-6 col-xs-12">
										<textarea class="form-control" name="certificate[rtme]" rows="3" placeholder=""><?php echo set_value('certificate[rtme]')?></textarea>
												...
												<select class="form-control" name="courses_id[]" multiple>
													<?php if(!empty($courses)){?>
														<?php foreach($courses as $course){?>
															<option value="<?php echo $course['id']; ?>"><?php echo ucfirst($course['title']); ?></option>
														<?php }?>
													<?php }?>
												</select>
											</div>
