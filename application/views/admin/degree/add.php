                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" data-parsley-validate="" id="edit_product_form" name="edit_product_form" enctype="multipart/form-data" method="POST" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" id="product-title" name="degree[title]" value="" class="form-control has-feedback-left required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
								    <textarea placeholder="Product Description" id="page_description" name="degree[description]"class="form-control required"></textarea>
