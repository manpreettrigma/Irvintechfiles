...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
			<form method="post" id="add_course" enctype="multipart/form-data" >
				<div class="x_content">
					<div class="x_panel">
									...
									<div class="form-horizontal form-label-left">
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input type="text" name="catalog_events[title]" class="form-control" placeholder="Event Name" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="flatpickr form-control" type="text" name="catalog_events[start_date]" placeholder="Select Date.." data-enable-time="true" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="flatpickr form-control" type="text" name="catalog_events[end_date]" placeholder="Select Date.." data-enable-time="true" required="required">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12">Timezone</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<select class="form-control" name="catalog_events[timezone]" required="required" >
										...
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<div class="radio">
													<label>
														<input type="radio" name="catalog_events[type]" value="1"  onchange="webinar_type('1')" id="optionsRadios1" name="optionsRadios" /> Live Webinar
													</label>
												</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<div class="radio">
													<label>
														<input type="radio" name="catalog_events[type]" value="2"  onchange="webinar_type('2')" id="optionsRadios1" name="optionsRadios" /> On-Demand Webinar
													</label>
												</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<textarea class="form-control" name="catalog_event_meta[short_desc]" rows="3" placeholder=""></textarea>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12">Long Description</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<textarea class="form-control" name="catalog_event_meta[longer_desc]" rows="3" placeholder=""></textarea>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12">Price<span class="required">*</span></label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input type="text" class="form-control" name="catalog_event_meta[price]" >
											</div>
										</div>					  
									</div>
								</div>
								...
								<div class="x_content">
									<div class="form-horizontal form-label-left">
										<div class="control-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input type="text" value="Computer,IT,Hardware" name="catalog_event_meta[topic_tag]" data-role="tagsinput" />
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<select class="form-control" name="catalog_event_meta[credit_events]" >
													...
													<?php foreach($category as $cate){?>
														<option value="<?php echo $cate['id']?>"><?php echo ucfirst($cate['title']); ?></option>
													<?php }?>
												</select>
											</div>
										</div>
										<div class="form-group">
											<label class="btn btn-success btn-lg">    
												...
												<div class="col-md-9 col-sm-9 col-xs-12">
													<input type="file" title="pdf" class="upload_content" style="display: none;" id="pdf_file" name="handout_pdf[]" class="form-control" placeholder="">
												</div>
											</label>
											<div class="fullWidth">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<select class="form-control" name="catalog_event_meta[speaker_events]">
													<?php foreach($get_presenter as $get_presenters)
														{ ?>
														<option value="<?php if(isset($get_presenters['username'])) echo $get_presenters['username']; ?>"><?php if(isset($get_presenters['username'])) echo $get_presenters['username']; ?></option>
												...
												<select class="form-control" name="catalog_event_meta[add_events]" multiple>
													...
													<?php if(!empty($providers)){?>
														<?php foreach($providers as $provider){?>
															<option value="<?php echo $provider['id']; ?>"><?php echo ucfirst($provider['username']); ?></option>
														<?php }?>
													<?php }?>
												</select>
											</div>
										...
										<div class="form-group">
											<label class="btn btn-success btn-lg">    
												...
												<div class="col-md-9 col-sm-9 col-xs-12">
													<input type="file" title="picture" style="display: none;" class="upload_content" name="banner[]" class="form-control" placeholder="">
												</div>
											</label>
	...
	$(document).ready(function () {
		...
		$('.upload_content').on("change", function (event) {
			...
			if (type == 'pdf' || type == 'csv') {
				...
				var url = '<?php echo base_url(); ?>admin/mastercatalog/uploader_ondemand';
			}
			else {
				$("#progress-wrp").show();
			...
			$.ajax({
				...
				if (type == 'pdf' || type == 'csv') {
					...
					$(".submit_button").html("");
					$(".submit_button").append('<button type="submit" name="edit_profile" class="btn btn-success btn-lg submit_button">Create Event</button>');
