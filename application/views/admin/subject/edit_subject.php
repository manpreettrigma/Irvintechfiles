        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
						<?php
						if ($this->session->flashdata('subject_message')) {
						$message = $this->session->flashdata('subject_message');
						?>
        ...
        ?>
                        ...
                        <form class="form-horizontal form-label-left" data-parsley-validate="" id="edit_subject_form" name="edit_subject_form" enctype="multipart/form-data" method="POST" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" id="" name="subject[title]" value="<?php if(isset( $subject_data -> title ))echo  $subject_data -> title ; ?>" class="form-control has-feedback-left required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12 form-group has-feedback">
								 <textarea placeholder="Product Description" id="page_description" name="subject[description]"class="form-control required"><?php if(isset( $subject_data -> description )) echo  $subject_data->description; ?></textarea>
                            ...
                            <br>
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12">
                                    <input  id="uploadImg"  type="hidden" value="<?php if(isset($subject_data -> image)) echo $subject_data -> image; ?> " name="upload_image" >
									
                                    <?php
                                    $page_image =$subject_data ->image ;
                                    ...
                                    if($page_image!='') {
                                        ...
                                        <div class="imageOuter">
                                           ...
                                           <img class="del_img" src="<?php echo base_url() . 'uploads/subjects_image/' . $page_image; ?>" >
                                        </div>

										<?php
										}
										?>
                                    <input type="file" name="subject_image" size="20" id="fileUpload" />
