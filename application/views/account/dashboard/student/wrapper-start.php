			...
			<div class="main-header">
				...
				<div class="buttons pull-right">
					...
					<div class="profileBtnOuterLogin"> 
						...
						<?php
							if($user_info['auth_id']!=0){
								if(isset($this->session->userdata['user_info']['meta_info']['profile_picture'])){
									$logo_image = $this->session->userdata['user_info']['meta_info']['profile_picture'];
									echo '<a href="javascript:void(0)" onclick="logout()">';
									echo '<img width="50" height="50" src="' . $logo_image. '">';
									echo '</a>';
								}
								}else{
