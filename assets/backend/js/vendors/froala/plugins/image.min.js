...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        imageUploadURL: "http://dev614.trigma.us/ladress/admin/Cms/file_upload_cms",
        ...
        function u() {
            var a = b.popups.get("image.insert"),
                c = a.find(".fr-image-by-url-layer input");
            c.val().length > 0 && (q(), s("Loading image"), x(c.val(), !0, [], qa), c.val(""), c.blur())
        }
        ...
        function Z() {
            if (K(), "IMG" == b.$el.get(0).tagName && b.$el.addClass("fr-view"), b.events.$on(b.$el, b.helpers.isMobile() && !b.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', ba), b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', function() {
                    ...
                    qa && (ma(), a.FE.copied_text = "\n", a.FE.copied_html = qa.get(0).outerHTML, "copy" == c.type ? setTimeout(function() {
                        v(qa)
                    }) : (ca(!0), b.undo.saveStep(), setTimeout(function() {
                        b.undo.saveStep()
                    }, 0)))
