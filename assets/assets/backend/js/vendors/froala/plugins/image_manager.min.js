...
! function(a) {
    ...
    if (a.extend(a.FE.DEFAULTS, {
            imageManagerLoadURL: "http://dev614.trigma.us/ladress/admin/Cms/image_manager_cms/",
            imageManagerLoadMethod: "get",
            imageManagerLoadParams: {},
            imageManagerPreloader: "",
            imageManagerDeleteURL: "http://dev614.trigma.us/ladress/admin/Cms/delete_image_cms/",
            ...
            function s(c) {
                ...
                confirm(e) && (b.opts.imageManagerDeleteURL ? b.events.trigger("imageManager.beforeDeleteImage", [d]) !== !1 && (d.parent().addClass("fr-image-deleting"), a.ajax({
                    ...
                    data: a.extend(a.extend({
                        src: d.attr("src")
                    }, q(d)), b.opts.imageManagerDeleteParams),
                    crossDomain: b.opts.requestWithCORS,
                    xhrFields: {
                        withCredentials: b.opts.requestWithCORS
                    },
            ...
            var A, B, C, D, E, F, G, H, I, J, K, L, M = 10,
                N = 11,
                O = 12,
                P = 13,
                Q = 14,
